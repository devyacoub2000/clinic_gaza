         ...
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               @if(getSettings('website_logo'))
                <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('settings_imgs/'.getSettings('website_logo'))}}"></a>
               @else
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item active">
                        <a class="nav-link" 
                        href="{{Auth::check() && Auth::user()->type == 'admin' ? route('admin.index') : route('front.index')}}">Home</a>
                     </li>
                     <li class="nav-item">
